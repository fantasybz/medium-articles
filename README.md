...
所有月份的撰稿、潤稿與中英翻譯，遵循 [作者寫作風格](STYLE.md)：動作交代完整，論述銜接清楚，讓真實經驗帶出溫度與故事。
...
| 2026-10 | [綠燈不是驗收：agent 時代的測試、Review 與可靠度](2026-10-green-overview/article.md)（第二個系列的總論） | [EN](2026-10-green-overview/article.en.md) | 已排程 10/06（一）09:00 發布；英文版草稿待排程 10/08；佇列見 [PUBLISHING.md](PUBLISHING.md) | [PUBLISHED.md](2026-10-green-overview/publish/PUBLISHED.md) |
| 2026-10 | [綠燈不是驗收（一）測試篇：怎麼審閱一份 agent 寫的測試—斷言鬆綁、凍結 bug 與 mutation score](2026-10-green-testing/article.md) | [EN](2026-10-green-testing/article.en.md) | 草稿已建，待排程 10/13（英文版 10/15）；佇列見 [PUBLISHING.md](PUBLISHING.md) | [PUBLISHED.md](2026-10-green-testing/publish/PUBLISHED.md) |
| 2026-10 | [綠燈不是驗收（二）Review 篇：Review 是控制點，不是瓶頸—分流、reviewer agent 艦隊與閉環禁令](2026-10-green-review/article.md) | [EN](2026-10-green-review/article.en.md) | 草稿已建，待排程 10/20（英文版 10/22）；佇列見 [PUBLISHING.md](PUBLISHING.md) | [PUBLISHED.md](2026-10-green-review/publish/PUBLISHED.md) |
| 2026-10 | [綠燈不是驗收（三）可靠度篇：SWE-Gate 量測到的 34%—constraint tests、pass^k 與授權擴張的閘門](2026-10-green-reliability/article.md) | [EN](2026-10-green-reliability/article.en.md) | 草稿已建，待排程 10/27（英文版 10/29）；佇列見 [PUBLISHING.md](PUBLISHING.md) | [PUBLISHED.md](2026-10-green-reliability/publish/PUBLISHED.md) |
