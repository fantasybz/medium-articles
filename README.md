...
| 2026-10 | [綠燈不是驗收：agent 時代的測試、Review 與可靠度—從 James Bach 的《Taking Testing Seriously》讀起](2026-10-green-overview/article.md)（第二個系列的總論） | [EN](2026-10-green-overview/article.en.md) | 草稿：批評／修訂、zh-tw 檢查、英文版皆完成，待作者校閱後以 `tools/medium_draft.sh` 建草稿發布；待辦見 [research/README.md](research/README.md) | — |
| 2026-10 | [綠燈不是驗收（一）測試篇：怎麼審一份 agent 寫的測試—斷言鬆綁、凍結 bug 與 mutation score](2026-10-green-testing/article.md) | [EN](2026-10-green-testing/article.en.md) | 草稿（同上） | — |
| 2026-10 | [綠燈不是驗收（二）Review 篇：Review 是控制點，不是瓶頸—分流、reviewer agent 艦隊與閉環禁令](2026-10-green-review/article.md) | [EN](2026-10-green-review/article.en.md) | 草稿（同上） | — |
| 2026-10 | [綠燈不是驗收（三）可靠度篇：SWE-Gate 量到的 34%—constraint tests、pass^k 與授權擴張的閘門](2026-10-green-reliability/article.md) | [EN](2026-10-green-reliability/article.en.md) | 草稿（同上） | — |
