...
發布時三部曲的另外兩篇尚未發表（Medium 限制每 24 小時最多發布 2 篇），
因此本篇有 4 處連結仍是 GitHub 相對路徑，在 Medium 上無效：

| # | 位置 | 要做的事 |
|---|---|---|
| 1 | 開頭「系列導覽」那行 | `[二、技術篇]` 換成技術篇的 Medium URL |
| 2 | 開頭「系列導覽」那行 | `[三、營運篇]` 換成營運篇的 Medium URL |
| 3 | 文末「系列文章」清單第 3 項 | 同上，技術篇 |
| 4 | 文末「系列文章」清單第 4 項 | 同上，營運篇 |
