...
export const meta = {
  ...
  description: 'Readability and flow pass over the four unreleased October articles, driven by the four per-article audits: three sequential in-place passes per article (terms → flow → the inserted paragraphs), a two-lens verify, the English mirror, a voice pass and the zh-tw gate — every stage ending with the voice_brief §9.2 mechanical invariants and the §9.4 protected-sentence check.',
  phases: [
