...
// args: { root, month, outline: 'research/YYYY-MM/<slug>.md', figures: 'research/YYYY-MM/<slug>.figures.md',
...
The four published pieces (voice reference; do not repeat their content): ${ROOT}/2026-09-agentic-engineering-platform/article.md, ${ROOT}/2026-09-agentic-org-design/article.md, ${ROOT}/2026-10-agentic-harness-blueprint/article.md, ${ROOT}/2026-11-agentic-eval-economics/article.md.
...
phase('Draft')
// args.skipDraft: the draft already exists at TARGET (e.g. written in the main loop); run only critique → revise → verify
