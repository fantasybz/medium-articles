...
中文三部曲先收完，英文四篇接在後面——中文版已經有兩篇上架、系列斷在「即將發布」，
英文四篇則是全新的，晚幾天沒有斷點問題。
...
| 1 | 技術篇（中） | `f2a139f5b561` | 草稿，備妥 |
| 2 | 營運篇（中） | `d6d9623c2dc6` | 草稿，備妥 |
| 3 | Overview（英） | `8187e7ec80f9` | 草稿，備妥 |
| 4 | Part 1 Org Design（英） | `92343384d987` | 草稿，備妥 |
| 5 | Part 2 Harness（英） | `3facc281f633` | 草稿，備妥 |
| 6 | Part 3 Evals（英） | `1cb1855a2046` | 草稿，備妥 |

六篇以每 24 小時 2 篇的上限算，最少要 3 天；一天一篇則是 6 天。
每篇發完就要立刻回頭補其他篇的連結，理由見上面第 3、4 點。
