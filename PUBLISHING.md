...
排程也吃「24 小時內最多發布或排程 2 篇」的配額，所以每天只能排兩篇，排完才在下表打勾。
...
| 3 | 測試篇（中） | `b01055139451` | 10/13（一）09:00 | 待排程 |
| 4 | 測試篇（英） | `51d001a6dcd5` | 10/15（三）09:00 | 待排程 |
| 5 | Review 篇（中） | `ccbf0cbe2691` | 10/20（一）09:00 | 待排程 |
| 6 | Review 篇（英） | `4d36d0f2f9c1` | 10/22（三）09:00 | 待排程 |
| 7 | 可靠度篇（中） | `3c64a9622777` | 10/27（一）09:00 | 待排程 |
| 8 | 可靠度篇（英） | `4b6d147bff0d` | 10/29（三）09:00 | 待排程 |
...
（分要在選完時之後再點一次才生效）→ Schedule to publish；Stories 頁的 Scheduled 清單顯示的是 UTC（09:00 GMT+8 顯示為 1:00 AM）。
