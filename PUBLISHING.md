...
**八篇全部上線，佇列已清空。** 中文四篇於 2026-09-03 收完，英文四篇於 2026-09-05 收完，
兩個語版彼此互連，中英也雙向互連。
...
| — | Part 2 Harness（英） | `3facc281f633` | 已發布 2026-09-04 23:52 |
| — | Part 3 Evals（英） | `1cb1855a2046` | 已發布 2026-09-05 09:40（一上線即完整）|

**能發幾篇就發幾篇**（2026-09-02 決定，原本是一天一篇）。上限允許就繼續發，被擋下來再停。

實際節奏比當初估的慢，因為 24 小時視窗是滾動的、不是自然日，每天真正空出的名額
常常只有一個：09-02 技術篇、09-03 營運篇＋EN Overview、09-04 EN Part 1＋EN Part 2。

滾動視窗要照「那一篇何時發的」往前推 24 小時，不是看日期換了沒。EN Part 2 卡到
09-04 23:32 才有位子，就是在等 EN Overview（09-03 23:32 發）滾出去。

推算下一個名額時要看**兩篇裡先滾出去的那一篇**，不是最後發的那一篇。Part 3 不必等
Part 2（09-04 23:52）滾出去，只要等 Part 1（09-04 08:26）滾出去，09-05 08:26 就有
位子了——實際 09:40 就發掉了，比「等最後一篇」的估算早了 14 小時。

八篇實際節奏：09-01 總論、09-02 組織篇＋技術篇、09-03 營運篇＋EN Overview、
09-04 EN Part 1＋EN Part 2、09-05 EN Part 3。
